              ...
              <div className="col-10">
                <div className="position-relative">
                  ...
                  <div className="position-absolute start-0 bottom-0 w-100 py-3 px-4 bgteam">
                    <h4 className="text-white">Mbouombouo Issah</h4>
              ...
              <div className="col-2">
                <div className="h-100 d-flex flex-column align-items-center justify-content-around bg-secondary py-5">
                  <a
                    ...
                    href="https://twitter.com/Mbouombouoissa1?t=Ghi4rWLUwRKhhQm8EfZUcw&s=08"
                  >
                    <i className="fab fa-twitter text-secondary"></i>
                  </a>
                  <a
                    className="btn btn-square rounded-circle bg-white"
                    href="https://www.facebook.com/issah.mbouombouo.35"
                  >
                    <i className="fab fa-facebook-f text-secondary"></i>
                  </a>
                  <a
                    className="btn btn-square rounded-circle bg-white"
                    href="https://www.instagram.com/invites/contact/?i=1e1u0osctyupz&utm_content=11cdzti"
                  >
              ...
              <div className="col-10">
                <div className="position-relative">
                  ...
                  <div className="position-absolute start-0 bottom-0 w-100 py-3 px-4 bgteam">
                    ...
                    <span className="text-white">Economiste</span>
                  </div>
                </div>
              </div>
              <div className="col-2">
