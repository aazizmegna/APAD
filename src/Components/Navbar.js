        ...
        <nav className="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav mx-auto py-0">
                    ...
                    <a href="service.html" className="nav-item nav-link">Nos Services</a>
                    <a href="product.html" className="nav-item nav-link">Notre équipe</a>
                    <a href="contact.html" className="nav-item nav-link">Nous Contacter</a>
                </div>
            </div>
        </nav>
    </div>
